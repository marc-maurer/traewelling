...
namespace App\Feature\TrainCheckin;
...
use App\Feature\TrainCheckin\DTO\TrainCheckinResult;
...
class TrainCheckin
{
    ...
    private function createTrainCheckin(
        Status       $status,
        HafasTrip    $trip,
        TrainStation $origin,
        TrainStation $destination,
        ...
        try {
            $trainCheckin         = \App\Models\TrainCheckin::create([
                                                                         'status_id'   => $status->id,
            ...
            return new TrainCheckinResult(
                $status,
                $pointsResource,
                StatusResource::collection($alsoOnThisConnection)
            );
